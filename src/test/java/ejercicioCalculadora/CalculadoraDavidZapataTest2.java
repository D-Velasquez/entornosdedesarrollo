...
class CalculadoraDavidZapataTest2 {
    private CalculadoraDavidZapata calc;
    @BeforeEach
    void setUp() {
        calc = new CalculadoraDavidZapata(20, 10);
    ...
    void testSumaConParametros(int valor) {
        CalculadoraDavidZapata calc = new CalculadoraDavidZapata (valor, 10);
    ...
    void testSumaConVariosValores(int a, int b, int resultadoEsperado) {
        CalculadoraDavidZapata calc = new CalculadoraDavidZapata(a, b);
